<%@ Page Language="C#" AutoEventWireup="true" CodeFile="4page1_index.aspx.cs" Inherits="SEGP_PRROJECT1.Theme.unify._4page_create_task" %>
...
<div class="wrapper">
    ...
    <div class="container">
     ...
     <br>
        <h1><u> These Groups with the following projects has been allocated to you from Admin   </u> </h1>
         <br>

     <br>
<asp:GridView ID="GridView1" runat="server" Width="949px" OnRowCommand="GridView1_RowCommand">
    <Columns>
        <asp:TemplateField HeaderText="Attachment">
            <ItemTemplate>
                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("File_Name") %>'     CommandName="Download"   Text='<%# Eval("File_Name") %>'></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
        </asp:GridView>
