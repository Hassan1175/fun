<%@ Page Language="C#" AutoEventWireup="true" CodeFile="3page1_index.aspx.cs" Inherits="SEGP_PROJECTNEWWW.Theme.unify._3page1_index" %>
...
<div class="wrapper">
    ...
    <br/>
    <div class="container">
     <h1><u> These Groups with the following projects has been allocated to you.   </u> </h1>

    <br/>
    <br/>
    <br/>
<asp:GridView ID="GridView1" runat="server" Width="926px" OnRowCommand="GridView1_RowCommand">
    <Columns>
