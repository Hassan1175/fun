<%@ Page Language="C#" AutoEventWireup="true" CodeFile="4page_progress.aspx.cs" Inherits="SEGP_PRROJECT1.Theme.unify._4page_progress" %>
...
<asp:Panel ID="Panel1" runat="server" Height="73px">
    <table class="auto-style8">
        <tr>
            <td class="auto-style9">Select Group ID</td>
            <td>
                <asp:DropDownList ID="DropDownList1" runat="server" Height="48px" Width="204px">
                </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
        </tr>
  ...
  <asp:Panel ID="Panel2" runat="server" Height="145px">
      <table class="auto-style8">
          <tr>
              <td class="auto-style10">Select Project </td>
              <td>
                  <asp:DropDownList ID="DropDownList2" runat="server" Height="18px" Width="202px">
                  </asp:DropDownList>
              </td>
              <td>&nbsp;</td>
          </tr>
    ...
    <asp:Panel ID="Panel3" runat="server" Height="73px">
