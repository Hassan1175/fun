<%@ Page Language="C#" AutoEventWireup="true" CodeFile="2page_update_project_entry.aspx.cs" Inherits="SEGP_PRROJECT1.Theme.unify._2page_update_project_entry" %>
...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <br />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SEGPConnectionString12 %>" DeleteCommand="DELETE FROM [project_data] WHERE [ID] = @ID" InsertCommand="INSERT INTO [project_data] ([Project_Name], [Budget], [Category], [Donar], [Description]) VALUES (@Project_Name, @Budget, @Category, @Donar, @Description)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [project_data]" UpdateCommand="UPDATE [project_data] SET [Project_Name] = @Project_Name, [Budget] = @Budget, [Category] = @Category, [Donar] = @Donar, [Description] = @Description WHERE [ID] = @ID">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="Donar" Type="String" />
            ...
            <div style="height: 350px;  overflow: auto;">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSource1" Width="1105px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    <Columns>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:BoundField DataField="Donar" HeaderText="Donar" SortExpression="Donar" />
