<%@ Page Language="C#" AutoEventWireup="true" CodeFile="2page_project_data.aspx.cs" Inherits="SEGP_PRROJECT1.Theme.unify.assets._2page_project_data" %>
...
<div class="wrapper">
		...
		<div class="collapse navbar-collapse mega-menu navbar-responsive-collapse">
			<div class="container" style="margin-right:160px">
				<ul class="nav navbar-nav">
					...
					<!-- Features -->
					<li ><a href="2page_RA_allocation.aspx">
							RA's Allocation
						</a>
    ...
    <br>
        ...
        <div>
                            <a href="2page_project_record.aspx" class="btn btn-success rounded hover-effect" > <h1 class="btn bg-color-white"><b>Update and Add New Projects</b></h1></a>
     ...
     <div style ="padding-left:310px">
         <h1>Records of all available Projects</h1>
         </div>
     
   <div  style ="height:300px; width:2250px">
       <br>
     <br>
      

<asp:GridView ID="GridView1" runat="server"  B BorderWidth="1px" CellPadding="3" CellSpacing="2" Width="1050px"></asp:GridView>
    <br>
     <br>
	</div>
        </div>
